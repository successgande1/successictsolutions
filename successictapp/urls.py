...
urlpatterns = [
    ...
    path('<int:pk>/update/education/', UpdateEducationDetails.as_view(), name = 'edit-education'), 
    path('<int:pk>/education/detail/', EducationDetail.as_view(), name = 'view-education'), 
    path('add/contact/', user_views.add_contact, name = 'applicant-contact'), 
   
    path('<int:pk>/contact/update/', UpdateContactDetails.as_view(), name = 'edit-contact'), 
    path('<int:pk>/contact/detail/', ContactDetail.as_view(), name = 'contact-details'),   
    path('applicant/add/training/session/', user_views.training_sessions, name = 'applicant-session'), 
    path('<int:pk>/update/app/session/', UpdateTrainingSessionDetails.as_view(), name = 'edit-session'), 
    path('<int:pk>/view/app/session/', TrainingSessionDetail.as_view(), name = 'view-session'), 
    ...
    path('applicant/codeof/conduct/', user_views.questionnaire, name = 'questionnaire'),
    path('<int:pk>/update/app/response/', UpdateQuestionnaireDetails.as_view(), name = 'edit-response'), 
    path('<int:pk>/view/app/response/', QuestionnaireDetail.as_view(), name = 'view-response'), 
