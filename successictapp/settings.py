"""
Django settings for successictapp project.
...
#SECRET_KEY = 'django-insecure-4-=)%@d1u=q#!lng7$%it*lojq=vgvib0y#sj%_0ujgj$otafr'
...
ROOT_URLCONF = 'successictapp.urls'
...
WSGI_APPLICATION = 'successictapp.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'successictapp/static')
]
