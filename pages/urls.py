...
urlpatterns = [
    ...
    path('affordable-and-professional-ict-consultancy-in-benue-state/', views.ict_consultancy, name ="ict-consultancy"),
    path('increase-online-visibility/', views.digital_services, name ="digital-services"),
